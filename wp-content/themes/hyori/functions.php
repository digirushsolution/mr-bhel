...
define( 'HYORI_THEME_VERSION', '1.3.0' );
...
function hyori_enqueue_scripts() {
	...
	// popup
	wp_enqueue_script( 'jquery-magnific-popup', get_template_directory_uri() . '/js/jquery.magnific-popup.min.js', array( 'jquery' ), '1.3.0', true );
	// unviel
	wp_enqueue_script( 'jquery-unveil', get_template_directory_uri() . '/js/jquery.unveil.js', array( 'jquery' ), '1.3.0', true );
	// perfect scrollbar
