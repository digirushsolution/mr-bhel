        ...
        public function setSections()
        {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'title' => esc_html__('Button Cart Color', 'hyori'),
                        'subtitle' => '<em>'.esc_html__('The button cart color of the site.', 'hyori').'</em>',
                    ...
                    array(
                        'title' => esc_html__('Button Cart Hover Color', 'hyori'),
                        'subtitle' => '<em>'.esc_html__('The button cart hover color of the site.', 'hyori').'</em>',
                    ...
                    array(
                        'title' => esc_html__('Button Cart Background Color 01', 'hyori'),
                        'subtitle' => '<em>'.esc_html__('The button color of the site.', 'hyori').'</em>',
                        'id' => 'bg_button_cart_color',
                        'type' => 'color',
                        'transparent' => false,
                    ),

                    array(
                        'title' => esc_html__('Button Cart Background Color 02', 'hyori'),
                        'subtitle' => '<em>'.esc_html__('The button color of the site.', 'hyori').'</em>',
                        'id' => 'bg_button_cart_color_2',
                        'type' => 'color',
                        'transparent' => false,
                    ),
