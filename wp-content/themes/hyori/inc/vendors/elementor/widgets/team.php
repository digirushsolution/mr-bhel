        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs('style_tabs');
                ...
                $this->add_control(
                    'name_color',
                    [
                        'label' => esc_html__( 'Name Color', 'hyori' ),
                ...
                $this->add_control(
                    'icon_bg',
                    [
                        'label' => esc_html__( 'Icon Bg Color', 'hyori' ),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
            ...
            $this->add_control(
                'border-radius',
                [
                    'label' => esc_html__( 'Border Radius Icon', 'hyori' ),
            ...
            $this->add_responsive_control(
                'width',
                [
                    'label' => esc_html__( 'Width Icon', 'hyori' ),
            ...
            $this->add_responsive_control(
                'height',
                [
                    'label' => esc_html__( 'Height Icon', 'hyori' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
            ...
            $this->add_group_control(
                ...
                [
                    'label' => esc_html__( 'Icon Typography', 'hyori' ),
            ...
            $this->add_responsive_control(
                'padding_inner',
                [
                    'label' => esc_html__( 'Padding Information', 'hyori' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    ...
    Plugin::instance()->widgets_manager->register( new Hyori_Elementor_Team );
}